...
public class ComparatorDemo {
	...
	public static void main(String[] args) {
        ...
        Developer d1 = new Developer(103, "Sravani", "Java");
        Developer d2 = new Developer(105, "Mary", "Dot Net");
        Developer d3 = new Developer(107, "Karthi", "Unit Testing");
        Developer d4 = new Developer(109, "Susie", "C#");
        Developer d5 = new Developer(111, "Tony", "Jira");
