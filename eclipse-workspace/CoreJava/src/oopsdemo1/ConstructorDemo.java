...
public class ConstructorDemo {
	...
	public static void main(String[] args) {
        ...
        ConstructorDemo cd2=new ConstructorDemo(102,"Nandu",6000.00f); // Invoke Parameterized Constructor
        ConstructorDemo cd3=new ConstructorDemo(103,"Sravani",7000.00f); 
